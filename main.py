...
OtherPic = pygame.image.load("scary.jpg")
...
def sheepMove(position):
    ...
    if position[2] == LEFT and position[0] >= 0:
        position[0]-= 4 #move left
    elif position[2] == RIGHT and position[0]+70 <= 800:
        position[0] += 4 #move right

    elif position[2] == UP and position[1] >= 0: 
        position[1] -= 4 #move up
    elif position[2] == DOWN and position[1]+70 <= 800:
        position[1] +=4  #move down
...
sheep2 = [300, 400, UP, False]
sheep3 = [400, 400, LEFT, False]
sheep4 = [200, 600, DOWN, False]
sheep5 = [300, 600, LEFT, False]
pig1 = [300, 600, LEFT, False]
...
gameover = False
while score<6 and gameover == False: #GAME LOOP############################################################
    clock.tick(60) #FPS
    timer+=1
    ...
    if pig1[3] == False: #don't draw them if they're already caught!
        #pygame.draw.rect(screen, (250, 100, 100), (sheep1[0], sheep1[1], 40, 40)) #use this if you don't have a jpg
        screen.blit(OtherPic, (pig1[0], pig1[1]))
